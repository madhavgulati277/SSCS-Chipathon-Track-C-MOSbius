...
C {vsource.sym} 100 -30 0 0 {name=V2 value="2.5 ac 1" savecurrent=false}
C {gnd.sym} 100 0 0 0 {name=l3 lab=0}
C {vsource.sym} 390 -30 0 0 {name=V3 value=2.5 savecurrent=false}
...
C {isource.sym} 10 -60 0 0 {name=I0 value=625u}
...
C {symbols/pfet_05v0.sym} 300 -150 0 0 {name=M1
L=1.2u
W=34.4u
nf=20
m=1
...
C {symbols/nfet_05v0.sym} 340 -60 0 1 {name=M3
L=0.60u
W=10u
nf=4
m=3
...
C {symbols/nfet_05v0.sym} 220 40 0 0 {name=M4
L=1.2u
W=16u
nf=8
m=2
